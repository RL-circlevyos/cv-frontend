      ...
      <div className="lg:flex items-center space-x-2 hidden w-full justify-between px-3 py-2">
        ...
        <div className="flex items-center space-x-5 ">
          <Link
            ...
            className="flex text-base items-center py-1.5 px-3 rounded-xl transition duration-200 bg-primary text-gray-100 focus:bg-cyan-900 dark:hover:bg-cyan-900 hover:bg-teal-800 hover:text-gray-100"
          >
            General
          </Link>
          <Link
